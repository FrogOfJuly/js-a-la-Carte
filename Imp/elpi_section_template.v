...
Elpi Accumulate Db is_section_template.db.
Elpi Accumulate Db section_template_vars.db.
Elpi Accumulate lp:{{ 
  ...
  :-  coq.say "Found section template:" SectionName
    ...
    , coq.env.begin-section SectionName
    , coq.elpi.accumulate _ "is_section_template.db" (clause _ (before "is_section_template.fail") TheNewRule)
    , coq.say "Printing:"
  ...
  :-  coq.say "Ending section template:" SectionName
    ...
    , coq.elpi.accumulate _ "section_template_vars.db" (clause _ (before "section_template_vars.fail") TheNewRule)
